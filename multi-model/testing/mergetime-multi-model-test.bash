...
# mergetime-multi-model-test.bash
#
# For example: mergetime-multi-model-test.bash azores BCC-CSM2-MR
#

USAGE_MESSAGE="Usage: mergetime-multi-model-test.bash <location> <model>"
