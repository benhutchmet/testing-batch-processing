...
# sel-grid-box-HadGEM-EC-Earth.test.bash
#
...
#
# Usage: sel-grid-box-HadGEM-EC-Earth.test.bash <location> <model> <year> <run>
#
# For example: sel-grid-box-HadGEM-EC-Earth.test.bash azores HadGEM3-GC31-MM 1960 1
#
