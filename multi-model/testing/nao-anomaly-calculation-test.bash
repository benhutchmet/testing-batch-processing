...
# nao-anomaly-calculation-test.bash
#
# Usage: nao-anomaly-calculation-test.bash <model>
#
# For example: nao-anomaly-calculation-test.bash BCC-CSM2-MR

USAGE_MESSAGE="Usage: nao-anomaly-calculation-test.bash <model>"
