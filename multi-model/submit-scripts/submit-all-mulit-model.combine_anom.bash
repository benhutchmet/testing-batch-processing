...
# submit-all-BCC-CSM2-MR.combine_anom.bash
#
# Usage:   submit-all-BCC-CSM2-MR.combine_anom.bash <location> <start_year> <finish_year>
...
EXTRACTOR=$PWD/BCC-CSM2-MR.combine_anom.bash
